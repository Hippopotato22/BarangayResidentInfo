...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen px-4 md:px-6 lg:px-10 gap-8 pt-20" style={{ background: backgroundColor }}>
      ...
      {/* Centered Header */}
      <h1
        className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-violet-600 bg-clip-text text-transparent animate-gradient-x text-center"
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div className="col-span-1 md:col-span-2 flex justify-center bg-[radial-gradient(circle_at_center,_#80d0ff,_#1e3a8a)] bg-[length:200%_200%] animate-[gradient_6s_ease_infinite] rounded-lg shadow-xl shadow-teal-500/50 p-4">
          <PopulationStats residents={residents} />
        </div>

        {/* Right Column: Resident List */}
        <div className="col-span-1 md:col-span-3 w-full bg-gradient-to-br from-blue-800 via-teal-700 to-teal-800 rounded-lg shadow-xl shadow-teal-500/50 p-4 md:p-6">
