    ...
    <div className="mt-6 max-w-4xl mx-auto px-4 sm:px-0">
      ...
      {deleteConfirmModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50">
          <div className="relative bg-dark-blue p-6 sm:p-10 rounded-3xl max-w-2xl w-full shadow-2xl transform transition-all duration-300 scale-100">
            <button
            ...
            {/* Waiver Text */}
            <div className="bg-red-50 p-6 rounded-xl mb-8 border-2 border-red-400 shadow-md flex items-start gap-4 fade-in-up">
              <svg
