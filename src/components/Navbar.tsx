...
import { Pencil, Save, X, Loader2, LogOut  } from 'lucide-react';
...
const [isLoggingOut, setIsLoggingOut] = useState(false);
 ...
 const saveNickname = async () => {
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1
            className="text-6xl font-bold animated-gradient-text"
  ...
  {user && nickname && (
    <div
      className="text-3xl text-white font-semibold hidden md:flex items-center gap-2"
